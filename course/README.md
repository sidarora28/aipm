...
- [Claude Code](https://docs.anthropic.com/claude/claude-code) installed and authenticated
- A computer that runs Claude Code
...
1. Clone this repo.
   ...
   cd course
   ```
2. Open the `course/` folder in Claude Code.
...
Make sure you opened the `course/` folder specifically — not the parent. The `CLAUDE.md` at `course/CLAUDE.md` is what kicks the course off.
